...
export function equipmentIconMarkup(
  ...
  const paths =
    kind === "extintor"
      ? `<path d="M9.5 3.75h5" /><path d="M14.5 3.75c1.35 0 2.5.9 2.5 2.15V8" /><path d="M17 8c0 1.4-1.2 2.15-2.5 2.15" /><path d="M12 3.75V6.5" /><path d="M9.25 6.5h5.5" /><path d="M8.4 8.25h7.2a1.4 1.4 0 011.4 1.4v9.1A2.75 2.75 0 0114.25 21.5h-4.5A2.75 2.75 0 017 18.75v-9.1a1.4 1.4 0 011.4-1.4z" /><path d="M9.75 12.25h4.5" />`
      : `<path d="M9 6.5h6v2.25H9z" /><path d="M10.25 3.75h3.5v2.75h-3.5z" /><path d="M8.5 8.75h7v8.5h-7z" /><path d="M6.25 10.75H8.5v2.5H6.25a.75.75 0 01-.75-.75v-1a.75.75 0 01.75-.75z" /><path d="M15.5 10.75h2.25a.75.75 0 01.75.75v1a.75.75 0 01-.75.75H15.5z" /><path d="M7.5 17.25h9v3H7.5z" />`;
