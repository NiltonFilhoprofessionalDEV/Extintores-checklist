      ...
      <ActiveBaseProvider>
        <div className="mobile-shell">
          ...
          <div className="mobile-shell__content">
            {isMapaRoute ? (
              <header
                className="flex shrink-0 items-center justify-between border-b border-[var(--fc-border)] bg-[var(--fc-surface)] px-4 py-2.5"
                style={{ paddingTop: "max(0.625rem, env(safe-area-inset-top, 0px))" }}
              >
                <button
                  type="button"
                  onClick={handleBackFromMap}
                  className="inline-flex min-h-[44px] items-center gap-1.5 rounded-[var(--fc-radius-md)] px-2 py-1.5 text-xs font-bold text-[var(--fc-text-primary)] hover:bg-[var(--muted)]"
                >
